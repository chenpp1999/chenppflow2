...
# T-GCN
python main.py --model_name TGCN --max_epochs 3000 --learning_rate 0.001 --weight_decay 0 --batch_size 256 --hidden_dim 64 --loss mse_with_regularizer --settings supervised --gpus 1
```
